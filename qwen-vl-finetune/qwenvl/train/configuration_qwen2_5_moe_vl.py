...
class Qwen2_5_moe_VLTextConfig(PretrainedConfig):
    r"""
    ...
    Args:
        ...
        norm_topk_prob (`float`, *optional*):
            Probability threshold for the topk normalization in the MoE layer.
        moe_intermediate_size (`int`, *optional*):
            Dimension of the intermediate size in the MoE layer.
        shared_expert_intermediate_size (`int`, *optional*):
            Dimension of the shared expert intermediate size in the MoE layer.
        adaptive_gate (`bool`, *optional*):
            Whether to use an adaptive gate in the MoE layer.
    ```python
    >>> from transformers import Qwen2_5_moe_VLTextModel, Qwen2_5_moe_VLConfig

    >>> # Initializing a Qwen2_5_VL style configuration
    >>> configuration = Qwen2_5_moe_VLConfig()

    >>> # Initializing a model from the Qwen2-VL-7B style configuration
    >>> model = Qwen2_5_moe_VLTextModel(configuration)
...
class Qwen2_5_moe_VLConfig(PretrainedConfig):
    r"""
    ...
    Args:
        text_config (`Union[PreTrainedConfig, dict]`, *optional*, defaults to `Qwen2_5_moe_VLTextConfig`):
    ...
    model_type = "qwen2_5_vl"
    sub_configs = {"vision_config": Qwen2_5_VLVisionConfig, "text_config": Qwen2_5_moe_VLTextConfig}
    keys_to_ignore_at_inference = ["past_key_values"]
...
__all__ = ["Qwen2_5_VLConfig", "Qwen2_5_moe_VLTextConfig", "Qwen2_5_moe_VLConfig", "Qwen2_5_VLTextConfig", "Qwen2_5_VLVisionConfig"]
