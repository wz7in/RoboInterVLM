...
import qwenvl.train.modeling_qwen2_5_moe_vl as modeling_qwen2_5_moe_vl
...
def replace_qwen2_vl_attention_class():
    ...
    modeling_qwen2_5_moe_vl._flash_attention_forward = (
        _flash_attention_forward
    )
    modeling_qwen2_5_moe_vl.Qwen2_5_VLModel._update_causal_mask = (
        _update_causal_mask
    )
    modeling_qwen2_5_moe_vl.Qwen2_5_VLMoeModel._update_causal_mask = (
        _update_causal_mask
    )
    modeling_qwen2_5_moe_vl._flash_attention_forward = (
        _flash_attention_forward
...
Qwen2_5_VLMoeModel.print_trainable_parameters = print_trainable_parameters
